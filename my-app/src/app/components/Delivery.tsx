...
const Delivery = () => {
  return (
    <main className=' w-full flex-col h-[450px] md:flex-row space-y-6 md:space-y-0 md:w-full md:h-[300px] top-[2463px] bg-[#FAF4F4] gap-5  flex items-center justify-center '>
        {/* section----1 */}
